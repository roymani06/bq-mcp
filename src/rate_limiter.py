...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    def _extract_client_key(self, request: Request) -> str:
        """Derive client key prioritizing authenticated Entra ID user over client IP."""
        # 1. Check authenticated user identity from request state
        ...
        # 2. Check X-Forwarded-For header if behind proxy/load balancer
